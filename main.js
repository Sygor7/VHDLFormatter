...
var VHDLFormatter = require("./VHDLFormatter");
...
var alignSettings = new VHDLFormatter.signAlignSettings(sign_align, sign_align_all, sign_align_mode, signAlignKeywords, align_comments);
var beautifierSettings = new VHDLFormatter.BeautifierSettings(false, false, false, alignSettings, keywordcase, typenamecase, indentation, newLineSettings, endOfLine, addNewLine);
var fs = require('fs');
var fileContents = fs.readFileSync('./mytext.txt').toString();
var output = VHDLFormatter.beautify(fileContents, beautifierSettings);
console.log(output);
