...
function alignSignalAssignmentBlock(settings, inputs, startIndex, endIndex, result) {
    if (settings.Indentation.replace(/ +/g, "").length == 0) {
        ...
        if (match != null) {
            ...
            var prefixLength = length_1 - settings.Indentation.length;
